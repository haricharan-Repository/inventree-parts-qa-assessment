 ...
 * with a "QA " prefix (see automation/api/utils/testData.ts and automation/ui/scripts/seed.js's
 * comment) — this script deletes every Part and Part Category matching that prefix, so repeated
 * runs against a shared instance don't accumulate data forever. It does NOT touch the seeded
 * baseline fixtures ("Electronics" category, "Resistance" parameter template), since neither
 * starts with "QA ".
 *
